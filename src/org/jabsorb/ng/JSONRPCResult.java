...
public class JSONRPCResult {
     ...
     * number of arguments.
     */
    public static final String MSG_ERR_NOMETHOD = "method with the requested number of arguments not found (session may"
            + " have timed out)";
     ...
     *            The result of the call
     */
    public JSONRPCResult(final int errorCode, final Object id, final Object o) {
     ...
     *            The result of the call
     * @param fixUps
     *            optional list of FixUp objects needed to resolve circular refs
     *            and duplicates.
     */
    public JSONRPCResult(final int errorCode, final Object id, final Object o,
        ...
        try {
            if (errorCode == CODE_SUCCESS) {
                ...
                if (fixUps != null && fixUps.size() > 0) {
                    ...
                    for (final Iterator<FixUp> i = fixUps.iterator(); i
                            .hasNext();) {
                ...
                if (result instanceof Throwable) {
                    ...
                    // an error result may be something other than Throwable. In
                    // this
                    // case, it has to be a JSON compatible object, we will just
                    // store it
            ...
            // this would have been a null pointer exception in the previous
            // json.org library.

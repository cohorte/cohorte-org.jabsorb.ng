...
public class ObjectMatch {
    ...
    /**
     * The objects can be converted into the same types, eg int converts into a
     * string.
     */
    public static final ObjectMatch SIMILAR = new ObjectMatch(-2);

    /**
     * The objects can be converted into the same types, but it should be
     * avoided eg any string can converts into a boolean, where "true" is true
     * and anything else is false.
     */
    public static final ObjectMatch ROUGHLY_SIMILAR = new ObjectMatch(-1);

    /**
     * The object was null, and therefore matches any object, (because any
     * object reference could be null)
     */
     ...
     * 
     * @param mismatch
     *            the number of mismatched fields that occured on a
     *            tryUnmarshall call.
     */
    ...
    /**
     * Set the mismatch on this ObjectMatch. The ObjectMatch cannot be immutable
     * anymore (at least in the current design-- because the same mismatch
     * object must be maintained through recursive processing to properly handle
     * circular references detection)
     * 
     * @param mismatch
     *            the mismatch value to set for this ObjectMatch.
     */

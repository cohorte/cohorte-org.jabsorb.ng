...
public class FixUp {
     ...
     * location of the circular reference or duplicate that this FixUp applies
     * to.
     */
     ...
     * 
     * @param fixupLocation
     *            a List of String|Integer's representing references to locate
     *            the place where this fixup entry needs to be created.
     * 
     * @param originalLocation
     *            List of String|Integer's representing references to locate the
     *            original location of the circular reference or duplicate that
     *            this FixUp applies to.
     */
    public FixUp(final List<Object> fixupLocation,
            final List<Object> originalLocation) {
    ...
    public JSONArray toJSONArray() {
        ...
        final JSONArray fixup = new JSONArray(fixupLocation);
        final JSONArray original = new JSONArray(originalLocation);
